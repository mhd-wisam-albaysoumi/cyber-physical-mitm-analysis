...
def run_simulation(attack_enabled=False):
    ...
    If attack_enabled is True, a MITM attack manipulates the sensor value.
    """
    ...
    for t in range(time_steps):
        ...
        # Sensor reads real water level
        measured_level = water_level

        # MITM attack manipulates sensor value
...
print("------------------------------------------------------------")
print(f"{'Metric':35s} {'Normal':15s} {'MITM Attack':15s}")
print("------------------------------------------------------------")
...
for metric in normal_metrics:
    ...
    if isinstance(normal_value, bool):
    ...
    print(f"{metric:35s} {normal_text:15s} {attack_text:15s}")
...
# -----------------------------
# Plot 2: Measured value under MITM attack
# -----------------------------
plt.figure()
